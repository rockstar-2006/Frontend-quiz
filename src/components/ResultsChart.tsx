...
export const ResultsChart = ({ players, question }: ResultsChartProps) => {
  ...
  if (question.type === 'multiple-choice') {
    ...
    // Show ALL unique answers (no limit)
  ...
  return (
    <div className="w-full max-w-5xl mx-auto glass-card p-8 rounded-3xl shadow-2xl">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold gradient-text mb-2">
          {question.type === 'text' ? 'Poll Results' : 'Answer Distribution'}
        </h2>
            ...
            <div key={index} className="flex flex-col items-center flex-1 h-full min-w-[100px] max-w-[150px]">
              <div className="flex-1 w-full flex flex-col justify-end">
                ...
                >
                  ...
                  <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-popover text-popover-foreground px-3 py-1 rounded-full text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    {data.count}
                  </div>
              ...
              <div className="mt-6 w-full text-center">
                ...
                <p className="text-sm text-foreground font-bold line-clamp-2 px-1 break-words">
                  {data.label}
                </p>
              </div>
            </div>
