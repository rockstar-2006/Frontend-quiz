...
import * as firebaseSocket from './firebaseSocket';
...
// Singleton instance
export const socket = USE_FIREBASE ? firebaseSocket.socket : new RealtimeSocket();
